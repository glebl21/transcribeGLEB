...
Использует **Groq Whisper Large V3 Turbo** для транскрибации и **GPT-5.4 Mini** для саммари.
...
| 📝 Краткое изложение | Саммари через GPT-5.4 Mini одной кнопкой |
...
- **OpenAI GPT-5.4 Mini** — frontier модель для саммари
